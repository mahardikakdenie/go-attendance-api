...
type PayrollRunType string

const (
	RunTypeRegular PayrollRunType = "Regular"
	RunTypeTHR     PayrollRunType = "THR"
	RunTypeBonus   PayrollRunType = "Bonus"
	RunTypeAll     PayrollRunType = "All"
)

type CalculationMethod string

const (
	MethodGross CalculationMethod = "Gross"
	MethodNet   CalculationMethod = "Net" // Gross Up
)
...
type Payroll struct {
	...
	RunType PayrollRunType    `gorm:"type:varchar(20);default:'Regular'" json:"run_type"`
	Method  CalculationMethod `gorm:"type:varchar(20);default:'Gross'" json:"method"`
