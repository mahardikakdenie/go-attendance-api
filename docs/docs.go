...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modelDto.UpgradeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modelDto.CreatePlanRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modelDto.UpdatePlanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/superadmin/subscriptions/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modelDto.UpdateTenantSubscriptionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/superadmin/subscriptions/{id}/suspend": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/modelDto.SuspendRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "modelDto.UpdateTenantSubscriptionRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
                ...
                "status": {
                    "description": "Active, Past Due, Canceled, Trial",
                    "type": "string"
                }
            }
        },
